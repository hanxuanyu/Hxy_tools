...
public class DeliverInfoBean {
    ...
    public static class ShowapiResBodyBean {
         ...
         * possibleExpList : [{"simpleName":"shunfeng","expName":"顺丰速运"}]
         * expTextName : 申通快递
         */
        ...
        public List<PossibleExpListBean> getPossibleExpList() {
            return possibleExpList;
        }

        public void setPossibleExpList(List<PossibleExpListBean> possibleExpList) {
            this.possibleExpList = possibleExpList;
        }
