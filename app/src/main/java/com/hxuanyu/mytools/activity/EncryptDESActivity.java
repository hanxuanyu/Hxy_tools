...
public class EncryptDESActivity extends BaseActivity {
    ...
    private void initEvent() {
        EncodeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EncodedText.setText(EncryptUtil.EncryptorDES(decodedText,key));
            }
        });
        ...
        DecodeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String key = KeyText.getText().toString();
                DecodedText.setText(EncryptUtil.DecryptorDES(encodedText,key));
            }
        });
    }
